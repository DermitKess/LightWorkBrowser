...
class CustomTabBar(QTabBar):
    def __init__(self, parent=None, theme_icon_folder="assets/icons_dark_theme"):
        super().__init__(parent)
        self.theme_icon_folder = theme_icon_folder
    ...
    def add_custom_close_button(self, index):
        btn = QPushButton()
        btn.setIcon(QIcon(f"{self.theme_icon_folder}/close_small.png"))
...
class CustomTabWidget(QTabWidget):
    def __init__(self, parent=None, theme_icon_folder="assets/icons_dark_theme"):
        super().__init__(parent)
        self.theme_icon_folder = theme_icon_folder
        self.setTabBar(CustomTabBar(self, self.theme_icon_folder))
